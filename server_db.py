    ...
    with get_connection() as conn:
        ...
        if cursor.fetchone()[0] == 0:
            default_services = [
                ...
                ('Optimización & Evaluación de Código Automatizado', 'Auditoría de seguridad, refactorización y pruebas unitarias de código existente.', 250, '2 días', 'fa-shield-halved', 0)
            ]
            cursor.executemany("""
